...
def next_turn(snake,food):
    ...
    snake.coordinates.insert(0,(x,y))# new location
    ...
    if x == food.coordinates[0] and y== food.coordinates[1]:
        ...
        canvas.delete("food")# use just the name of the tag to delete it
        food = Food()
    else:
        # to ensure that our snake is moving (delete)
...
window.resizable(False,False)# we cannot resize the window
